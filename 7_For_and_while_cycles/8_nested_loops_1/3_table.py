...
# Напишите программу, которая печатает таблицу сложения для всех чисел от 1 до n (включительно)
...
for i in range(1, n + 1): # от 1 до n (строка)
    for j in range(1, 10): # от 1 до 9 (включительно) (столбец)
        print(i, '+', j, '=', i + j)
    print()
